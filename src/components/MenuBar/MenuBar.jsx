  ...
  return (
    <header className="menubar glass">
      <div className="menubar__left">
        <button className="menubar__btn" aria-label="Apple">
          <img className="menubar__appleImg" src={appleIcon} alt="Apple" />
        </button>

        <span className="menubar__item menubar__item--bold">Finder</span>
        <span className="menubar__item">Archivo</span>
        <span className="menubar__item">Edición</span>
        <span className="menubar__item">Ver</span>
        <span className="menubar__item">Ir</span>
        <span className="menubar__item">Ventana</span>
        <span className="menubar__item">Ayuda</span>
      </div>

      <div className="menubar__right">
        {/* Batería  */}
        <div className="menubar__battery" title="Batería">
          <span className="menubar__batteryPct">{batteryPct}%</span>
          <span className="menubar__batteryPill" aria-hidden="true">
            <span
              className="menubar__batteryLevel"
        ...
        {/* Wi-Fi */}
        <button
          className="menubar__btn menubar__icon"
          title="Wi-Fi"
          aria-label="Wi-Fi">
        ...
        <button
          ...
          <img src={controlCenter} alt="Centro de Control" />
        </button>

        {/* Fecha y Hora */}
        <span className="menubar__clock" title="Fecha y hora">
          {label}
        </span>
      </div>
    </header>
